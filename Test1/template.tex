...
\documentclass[
	...
	10pt, % Default font size, can also use 11pt or 12pt, although this is not recommended打撒打
	unnumberedsections, % Comment to enable section numbering
	twoside, % Two side traditional mode where headers and footers change between odd 而且 pages, comment this option to make them fixed
]{LTJournalArticle}
